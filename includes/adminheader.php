...
<!-- Primary Meta Tags -->
<title>LinksFlow - Admin Panel</title>
...
<!-- Notyf -->
<link type="text/css" href="<?php echo BASE_URL . '/assets/vendor/notyf/notyf.min.css'; ?>" rel="stylesheet">
...
<nav class="navbar navbar-dark navbar-theme-primary px-4 col-12 d-lg-none">
    <a class="navbar-brand me-lg-5" href="../index.html">
        <img class="navbar-brand-dark" src="<?php echo BASE_URL . '/assets/img/brand/light.svg'?>" alt="Volt logo" /> <img class="navbar-brand-light" src="../assets/img/brand/dark.svg" alt="Volt logo" />
    </a>
  ...
  <div class="sidebar-inner px-4 pt-3">
    ...
    <ul class="nav flex-column pt-3 pt-md-0">
      <li class="nav-item">
        <a href="<?php echo BASE_URL . '/admin/dashboard.php'?>" class="nav-link d-flex align-items-center">
          <span class="sidebar-icon">
            <img src="<?php echo BASE_URL . '/assets/img/brand/light.svg'?>" height="20" width="20" alt="Volt Logo">
          </span>
          <span class="mt-1 ms-1 sidebar-text">Links Flow</span>
        </a>
      </li>
      ...
      <li class="nav-item">
        <a href="<?php echo BASE_URL . '/admin/posts/index.php'?>"  class="nav-link d-flex justify-content-between">
          <span>
            <span class="sidebar-icon">
  ...
  <path fill-rule="evenodd" d="M13.5 5a.5.5 0 0 1 .5.5V7h1.5a.5.5 0 0 1 0 1H14v1.5a.5.5 0 0 1-1 0V8h-1.5a.5.5 0 0 1 0-1H13V5.5a.5.5 0 0 1 .5-.5z"/>
        ...
        <!-- <li class="nav-item">
          <a href="<?php echo BASE_URL . '/admin/site/index.php'?>" 
            class="nav-link d-flex align-items-center">
            <span class="sidebar-icon">
    ...
    <path d="M7.068.727c.243-.97 1.62-.97 1.864 0l.071.286a.96.96 0 0 0 1.622.434l.205-.211c.695-.719 1.888-.03 1.613.931l-.08.284a.96.96 0 0 0 1.187 1.187l.283-.081c.96-.275 1.65.918.931 1.613l-.211.205a.96.96 0 0 0 .434 1.622l.286.071c.97.243.97 1.62 0 1.864l-.286.071a.96.96 0 0 0-.434 1.622l.211.205c.719.695.03 1.888-.931 1.613l-.284-.08a.96.96 0 0 0-1.187 1.187l.081.283c.275.96-.918 1.65-1.613.931l-.205-.211a.96.96 0 0 0-1.622.434l-.071.286c-.243.97-1.62.97-1.864 0l-.071-.286a.96.96 0 0 0-1.622-.434l-.205.211c-.695.719-1.888.03-1.613-.931l.08-.284a.96.96 0 0 0-1.186-1.187l-.284.081c-.96.275-1.65-.918-.931-1.613l.211-.205a.96.96 0 0 0-.434-1.622l-.286-.071c-.97-.243-.97-1.62 0-1.864l.286-.071a.96.96 0 0 0 .434-1.622l-.211-.205c-.719-.695-.03-1.888.931-1.613l.284.08a.96.96 0 0 0 1.187-1.186l-.081-.284c-.275-.96.918-1.65 1.613-.931l.205.211a.96.96 0 0 0 1.622-.434l.071-.286zM12.973 8.5H8.25l-2.834 3.779A4.998 4.998 0 0 0 12.973 8.5zm0-1a4.998 4.998 0 0 0-7.557-3.779l2.834 3.78h4.723zM5.048 3.967c-.03.021-.058.043-.087.065l.087-.065zm-.431.355A4.984 4.984 0 0 0 3.002 8c0 1.455.622 2.765 1.615 3.678L7.375 8 4.617 4.322zm.344 7.646.087.065-.087-.065z"/>
            ...
            <span class="sidebar-text">tings</span>
          </a>
        </li>
      -->
  ...
  <path fill-rule="evenodd" d="M7.293 1.5a1 1 0 0 1 1.414 0l6.647 6.646a.5.5 0 0 1-.708.708L8 2.207 1.354 8.854a.5.5 0 1 1-.708-.708L7.293 1.5z"/>
          ...
          <span class="sidebar-text">Main Page </span>
        </a>
      </li>
      <li class="nav-item">
...
<div class="input-group input-group-merge search-bar">
  ...
  <input type="search" class="form-control"  placeholder="" ariacontrols="dataTable">
  </div>
</div>
</form>
<!-- / Search form -->
