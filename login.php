    ...
    <main>
        ...
        <section class="vh-lg-100 mt-5 mt-lg-0 bg-soft d-flex align-items-center">
            <div class="container">
                ...
                <div class="row justify-content-center form-bg-image" data-background-lg="<?php echo BASE_URL . '/assets/img/illustrations/signin.svg'?>">
                    <div class="col-12 d-flex align-items-center justify-content-center">
                        <div class="bg-white shadow border-0 rounded border-light p-4 p-lg-5 w-100 fmxw-500">
                            ...
                            <form action="login.php" method="post" class="mt-4">
                                ...
                                <div class="d-grid">
                                    <button type="submit" name="login-btn" class="btn btn-gray-800">Sign in</button>
                                </div>
                            </form>
                            ...
                            <div class="d-flex justify-content-center align-items-center mt-4">
                                <span class="fw-normal">
                                    Not registered?
                                    <a href="<?php echo BASE_URL . '/register.php' ?>" class="fw-bold">Create account</a>
                                </span>
                            </div>
                        </div>
                    </div>
