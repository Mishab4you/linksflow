                    ...
                    <div class="col-12 d-flex align-items-center justify-content-center">
                        <div class="bg-white shadow border-0 rounded border-light p-4 p-lg-5 w-100 fmxw-500">
                            ...
                            <form action="register.php" method="post" class="mt-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="password" name="passwordConf"  value="<?php echo $passwordConf; ?>" class="form-control" required>
                                        </div>  
                                    </div>
                                    <!-- End of Form -->
                                    <div class="mb-4">
                                ...
                                <div class="d-grid">
                                    <button type="submit"  name="register-btn" class="btn btn-gray-800">Sign up</button>
                                </div>
                            </form>
                            ...
                            <div class="d-flex justify-content-center align-items-center mt-4">
                                <span class="fw-normal">
                                    ...
                                    <a href="<?php echo BASE_URL . '/login.php' ?>" class="fw-bold">Login here</a>
                                </span>
                            </div>
                        </div>
                    </div>
