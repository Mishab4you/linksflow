...
<?php include(ROOT_PATH . "/includes/messages.php"); ?>
                ...
                <div class="d-flex justify-content-between w-100 flex-wrap">
                    <div class="mb-3 mb-lg-0">
                        ...
                        <p class="mb-0">Save your personal link in here. Dont worry about privacy we will care it all!.</p>
                    </div>
                </div>
                <div class="py-4">
            <div class="row">
...
<?php
    while($user_data = mysqli_fetch_array($result)) {
        ...
        <button class='btn btn-danger d-inline-flex align-items-center me-2 dropdown-toggle' data-bs-toggle='dropdown' aria-haspopup='true' aria-expanded='false'>
            ...
            <a class='dropdown-item d-flex align-items-center'  data-bs-toggle='modal' data-bs-target='#modal-form' href='index.php?id=$user_data[id]'>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-group mb-4">
                                                                    ...
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input type="text" placeholder="The purpose of your link" class="form-control"  name="email" required>
                                                                    </div>  
                                                                </div>
                                                                <!-- End of Form -->
                                                                <!-- Form -->
                                                                <div class="form-group mb-4">
                                                                    ...
                                                                    <div class="input-group">
                                                                        ...
                                                                        <textarea type="text" placeholder="The working link" class="form-control" name="mobile" required></textarea>
                                                                    </div>  
                                                                </div>
                                                                <!-- End of Form -->
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-group mb-4">
                                                                    ...
                                                                    <div class="input-group">
                                                                        ...
                                                                        <p type="text" placeholder="Password" class="form-control" name="mobile" required><?php echo $mobile;?></p>
                                                                    </div>  
                                                                </div>
                                                                <!-- End of Form -->
