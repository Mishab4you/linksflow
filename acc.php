            ...
            <div class="col-12 col-xl-12">
                        ...
                        <div class="col-12 mb-4">
                            <div class="card shadow border-0 text-center p-0">
                                ...
                                <div class="card-body pb-5">
                                    <img src="<?php echo BASE_URL . '/assets/img/team/profile-picture-1.jpg'?>" class="avatar-xl rounded-circle mx-auto mt-n7 mb-4" alt="Neil Portrait">
                                    <h4 class="h3"><?php echo $_SESSION['username']; ?></h4>
                                    <h5 class="fw-normal mb-3"><?php echo $_SESSION['email']; ?></h5>
                                    ...
                                    <a class="btn btn-sm btn-secondary" href="<?php echo BASE_URL . '/personal/index.php'?>">My Links</a>
                                    <?php if($_SESSION['admin']): ?>
                            <a class="btn btn-sm btn-danger" href="<?php echo BASE_URL . '/admin/dashboard.php'?>">Admin Panel</a>
                        <?php endif;?>
                                </div>
                             </div>
                        </div>
                ...
                <div class="card card-body border-0 shadow mb-4">
                        ...
                        <form>
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <div>
                                        ...
                                        <p class="form-control" id="first_name" type="text" placeholder="Enter your first name" required><?php echo $_SESSION['username']; ?></p>
                                    </div>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <div>
                            ...
                            <div class="mt-2">
                                <button class="btn btn-gray-800 mt-2 animate-up-2" type="submit">Edit Details</button>
                                <button class="btn btn-secondary mt-2 animate-up-2" type="submit">Change Password</button>
