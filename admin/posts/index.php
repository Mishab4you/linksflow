...
?></h3>
            ...
            <div class="dropdown">
                    ...
                    <a class="dropdown-item d-flex align-items-center" href="" data-bs-toggle="modal" data-bs-target="#addlink">Add New Links</a>   
                    <a class="dropdown-item d-flex align-items-center" href="">Manage Links</a>                                   
                        ...
                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <?php foreach ($posts as $key => $post): ?>
                                ...
                                <tr>
                                    ...
                                    <td class="fw-bold d-flex align-items-center"><?php echo $post['title'] ?></td>
                                    ...
                                    <td></td>  <?php if ($post['published']): ?>
                                        <td><a href="edit.php?published=0&p_id=<?php echo $post['id'] ?>" class="btn btn-danger">unpublish</a></td>
                                    <?php else: ?>
